...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/productos/')); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/categorias/')); ?>">
      <i class="bi bi-folder"></i>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/items/')); ?>">
      <i class="bi bi-folder"></i>
      <span>Items</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/imagenes/')); ?>">
      <i class="bi bi-folder"></i>
      <span>Imagenes</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/etiquetas/')); ?>">
      <i class="bi bi-folder"></i>
      <span>Etiquetas</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/usuarios/')); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/opciones/')); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="<?php echo e(url('/categorias/')); ?>"> <!--meter ruta -->
